...
cosmos_user_agent = f"Cosmos/{__version__}"
...
def install_playwright(io):
    ...
    pip_cmd = utils.get_pip_install(["cosmos-chat[playwright]"])
...
class Scraper:
    ...
    def scrape_with_httpx(self, url):
        ...
        headers = {"User-Agent": f"Mozilla./5.0 ({cosmos_user_agent})"}
        try:
            with httpx.Client(
