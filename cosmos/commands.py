...
class Commands:
    ...
    def cmd_chat_mode(self, args):
        ...
        show_formats = OrderedDict(
            [
                ("help", "Get help about using cosmos (usage, config, troubleshoot)."),
    ...
    def cmd_undo(self, args):
        "Undo the last git commit if it was done by cosmos"
        try:
    ...
    def raw_cmd_undo(self, args):
        ...
        if last_commit_hash not in self.coder.cosmos_commit_hashes:
            self.io.tool_error("The last commit was not made by cosmos in this chat session.")
            self.io.tool_output(
    ...
    def cmd_add(self, args):
        "Add files to the chat so cosmos can edit them or review them in detail"
        ...
        for word in filenames:
            ...
            if self.coder.repo and self.coder.repo.ignored_file(fname):
                self.io.tool_warning(f"Skipping {fname} due to cosmosignore or --subtree-only.")
                continue
    ...
    def basic_help(self):
        ...
        self.io.tool_output()
        self.io.tool_output("Use `/help <question>` to ask questions about how to use cosmos.")

    def cmd_help(self, args):
        "Ask questions about cosmos"
        ...
        from cosmos.coders.base_coder import Coder
        ...
        user_msg += """
# Announcement lines from when this session of cosmos was launched:
...
"""
    ...
    def cmd_report(self, args):
        ...
        from cosmos.report import report_github_issue
